...
function valor_SanCor(aportesOS, coeficiente, edad_1, edad_2, numHijos, precio_1Hijo, precio_2Hijo, precio_Titular, precios_Conyuge, numhijo_2, grupo_Fam, boolean_afinidad, promo, genSanCor) {
    let edad2 = edad_2;
    let hijos = numHijos;
    ...
    for (let j in precios) {
        ...
        // 2. Aplicamos la lógica: 
        let otrosCargos = (nombrePlanBase.includes('5000') ||
