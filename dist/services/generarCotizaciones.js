...
exports.procesarTodo = void 0;
const database_1 = require("../config/database");
const cotizacion_1 = require("./cotizacion"); // Tu función que pide (req, res)
const procesarTodo = async (fechaManual) => {
    ...
    let continuar = true;
    while (continuar) {
        const { data: filas, error } = await database_1.supabase
        ...
        for (const fila of filas) {
            try {
                ...
                if (totalProcesadas % 50 === 0)
                    console.log(`🚀 Procesadas: ${totalProcesadas}...`);
            }
            catch (err) {
...
exports.procesarTodo = procesarTodo;
